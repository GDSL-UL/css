...
The course material is **based on the previously taught course on Population Data Science**, designed by Prof Francisco Rowe, Dr Carmen Cabrera and Dr Elisabetta Pietrostefani. The previous version of this course is available [here](https://github.com/fcorowe/r4ps).


This website is free to use and is licensed under the [Attribution-NonCommercial-NoDerivatives 4.0 International](https://creativecommons.org/licenses/by-nc-nd/4.0/). A compilation of this web course is hosted as a GitHub repository that you can access:

-   As a [download](https://github.com/ul-css/r4ps/archive/refs/heads/main.zip) of a `.zip` file that contains all the materials.
-   As an [html website](https://computational-social-science.com).
